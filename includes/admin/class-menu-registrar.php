...
final class MenuRegistrar
{
    ...
    public function renderSettingsPage(): void
    {
        ...
        <div class="wrap seoworkerai-admin-page">
            ...
            <?php if (! empty($providerAlerts)) {
                foreach ($providerAlerts as $key => $alert) {
                    if (! is_array($alert)) {
                        continue;
                    } ?>
            ...
            <div class="seoworkerai-card seoworkerai-card-wide" style="margin-bottom:16px;">
                ...
                <div class="seoworkerai-stat-grid">
                    ...
                    <div class="seoworkerai-stat">
                        <span>Automation Access</span>
                        <strong><?php echo esc_html(empty($billing['payment_required']) ? 'Active' : ($isInitialAuditCompleted ? 'Payment required' : 'Included during first audit')); ?></strong>
                    </div>
                    <div class="seoworkerai-stat">
            ...
            <div class="seoworkerai-settings-grid">
                ...
                <section class="seoworkerai-card">
                    <div class="seoworkerai-card-head">
                        ...
                        <?php if ($shouldShowPaymentPrompt && ! empty($billing['payment_url'])) { ?>
                    ...
                    <p class="description" style="margin-top:0;">
                        Your first site-wide audit is included. We scan every page once and fix issues automatically based on your Change Application Mode setting.
                    </p>
                    ...
                    <?php if (! $isInitialAuditCompleted) { ?>
                        <p class="description" style="margin-top:-4px;">
                            <?php echo esc_html($isInitialAuditRunning ? 'Initial audit is in progress.' : 'Initial audit will start automatically.'); ?>
                            <?php
                            $auditProgressParts = [];
                        $auditProgressParts[] = 'Issues found: '.(string) $auditMetrics['issues_found'];
                        $auditProgressParts[] = 'Applied automatically: '.(string) $auditMetrics['applied'];
                        $auditProgressParts[] = 'Needs human review: '.(string) $auditMetrics['needs_human_review'];
                        echo esc_html(' '.implode(' · ', $auditProgressParts));
                        ?>
                        </p>
                    <?php } ?>
                    <div class="seoworkerai-kv-list" style="margin-bottom:16px;">
                        <div><span>Status</span><strong><?php echo esc_html(empty($billing['payment_required']) ? 'Active' : ($isInitialAuditCompleted ? 'Payment required' : 'Initial audit included')); ?></strong></div>
                    ...
                    <?php } else { ?>
                        <div class="seoworkerai-kv-list" style="margin-bottom:14px;">
                            ...
                            <?php if ($oauthError !== '') { ?><div><span>Last Error</span><strong style="color:var(--red);"><?php echo esc_html($oauthError); ?></strong></div><?php } ?>
                        </div>
                        <div class="seoworkerai-button-row">
                            <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
                                <?php wp_nonce_field('seoworkerai_start_oauth'); ?>
                                                        ...
                                                        <label><?php echo esc_html($fl); ?>
                                                            <?php if ($ft === 'textarea') { ?>
                                                                <textarea
                                                                    ...
                                                                    <?php if ($fvalidation !== '') { ?>data-validation="<?php echo esc_attr($fvalidation); ?>"<?php } ?>
                    ...
                    <?php if (! empty($items)) { ?>
                        <?php foreach ($items as $item) { ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($targetLabel !== '') { ?><div><?php echo esc_html($targetLabel); ?></div><?php } ?>
                                    <?php if ($targetUrl !== '') { ?><a href="<?php echo esc_url($targetUrl); ?>" target="_blank" rel="noopener noreferrer" class="seoworkerai-muted" style="font-size:12px;">↗ View</a><?php } ?>
                                </td>
                            ...
                            <div class="seoworkerai-brief-header">
                                <div>
                                    ...
                                    <div class="seoworkerai-brief-meta">
                                        <?php if ($focusKw !== '') { ?><span>🔑 <?php echo esc_html($focusKw); ?></span><?php } ?>
                                        <?php if ($searchIntent !== '') { ?><span>🎯 <?php echo esc_html($searchIntent); ?></span><?php } ?>
                                        <?php if ($keywordType !== '') { ?><span>Type: <?php echo esc_html(ucfirst($keywordType)); ?></span><?php } ?>
                                        <?php if ($strategyTemplate !== '') { ?><span>Template: <?php echo esc_html($strategyTemplate); ?></span><?php } ?>
                                        <?php if ($primarySubreddit !== '') { ?><span>r/<?php echo esc_html($primarySubreddit); ?></span><?php } ?>
                                        <?php if ($searchVolume !== null) { ?><span>SV: <?php echo esc_html((string) $searchVolume); ?></span><?php } ?>
                                        <?php if ($keywordDifficulty !== null) { ?><span>KD: <?php echo esc_html((string) $keywordDifficulty); ?></span><?php } ?>
                            ...
                            <div class="seoworkerai-brief-body">
                                ...
                                <div class="seoworkerai-brief-col">
                                    ...
                                    <ul class="seoworkerai-brief-ul">
                                        <?php foreach ($outlineItems as $item) { ?><li><?php echo esc_html($item); ?></li><?php } ?>
                                    </ul>
                                </div>
                                <?php } ?>
                                ...
                                <div class="seoworkerai-brief-col">
                                    <?php if (! empty($painPoints)) { ?>
                                        ...
                                        <ul class="seoworkerai-brief-ul">
                                            <?php foreach ($painPoints as $item) { ?><li><?php echo esc_html($item); ?></li><?php } ?>
                                        </ul>
                                    <?php } ?>
                                    <?php if (! empty($contentIdeas)) { ?>
                                        <h4 style="margin-top:14px;">Content Angles</h4>
                                        <ul class="seoworkerai-brief-ul">
                                            <?php foreach ($contentIdeas as $item) { ?><li><?php echo esc_html($item); ?></li><?php } ?>
                                        </ul>
                                    <?php } ?>
                                </div>
                                <?php } ?>
                                ...
                                <div class="seoworkerai-brief-col-full">
                                    ...
                                    <ul class="seoworkerai-brief-ul" style="columns:2;gap:16px;">
                                        <?php foreach ($threads as $t) { ?><li><?php echo esc_html($t); ?></li><?php } ?>
                                    </ul>
                                </div>
                                <?php } ?>
                            </div>
    ...
    private function resolveTimelineEventLabel(string $eventType, string $status): string
    {
        ...
        if ($ev === 'queued' && strtolower(trim($status)) === 'running') {
            return 'running';
        }
